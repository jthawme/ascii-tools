...
export class AsciiCanvas {
  ...
  /**
   *
   * @param {string} baseChars The starting set of characters
   * @param {string} spliceChars The set of characters you wish to splice into the base
   * @param {number} [x] Which x character to start at
   * @param {number} [y] Which y character to start at
   * @returns {string}
   */
